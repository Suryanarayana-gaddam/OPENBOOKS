  ...
  return (
    (!isLoading && <div className='px-4 mt-5 lg:px-10 flex flex-col md:flex-row justify-between items-center gap-12'>
        ...
        <div className='md:w-1/2 space-y-6'>
         <h2 className='text-3xl md:text-4xl lg:text-5xl font-bold my-5 md:w-3/4 leading-snug'>Find Your Favorite <span className='text-blue-700 '>Book Here!</span></h2>
            ...
            <div className='flex flex-col sm:flex-row justify-between gap-6 md:w-3/4 my-14'>
              <div>
                <h3 className='text-xl md:text-2xl lg:text-3xl font-bold '>{bookCount}</h3>
                <p className='text-base'>Books Available</p>
              </div>
              <div>
                <h3 className='text-xl md:text-2xl lg:text-3xl font-bold '>{userCount}</h3>
                <p className='text-base'>Happy Readers</p>
              </div>
              <div>
                <h3 className='text-xl md:text-2xl lg:text-3xl font-bold '>{orderCount}</h3>
