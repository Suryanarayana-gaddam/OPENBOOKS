                ...
                <Table.Row className="bg-white dark:border-gray-700 dark:bg-gray-800">
                  ...
                  <Table.Cell>
                    ...
                    
                    {
                        userInfo.role == "admin" ?
                          (<div>
                            <button className='bg-green-600 px-4 py-1 font-semibold text-white rounded hover:bg-blue-500 hover:text-white ml-8'>{userInfo.email == "suryanarayanagaddam020@gmail.com" ? 'Owner' : 'Admin'} </button>
                            {
